...
const Telford = () => {
  return (
    <>
      <Helmet>
        <title>Gluten-Free Meal Prep Telford TN | SmashMeals Free Delivery</title>
        <meta name="description" content="Fresh gluten-free meal prep delivered FREE to Telford, TN. Chef-prepared meals delivered Sunday-Monday. Order by Thursday." />
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              <div className="flex items-center justify-center gap-2 text-primary">
                ...
                <span className="text-lg font-semibold">Serving Telford, TN</span>
              </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Made fresh in Tri-Cities</p>
              </Card>
              <Card className="p-6 text-center">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4">Pickup Option</h3>
