...
const Alcoa = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Gluten-Free Meal Prep Alcoa TN | SmashMeals Delivery</title>
        <meta name="description" content="Fresh gluten-free meal prep delivery to Alcoa, TN. Chef-prepared meals for busy professionals." />
        <meta name="keywords" content="meal prep Alcoa, gluten free Alcoa TN, healthy meal delivery Alcoa" />
        <link rel="canonical" href="https://smashmeals.com/alcoa" />
      </Helmet>

      <CitySchema cityName="Alcoa" state="Tennessee" stateAbbr="TN" />
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              <div className="flex items-center justify-center gap-2 text-primary">
                ...
                <span className="text-lg font-semibold">Now Shipping to Alcoa, TN</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold font-playfair">
                Gluten-Free Meal Prep<br />for Alcoa
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Fresh, chef-prepared meals delivered to Alcoa and surrounding areas.
              </p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Delivered to Alcoa</p>
              </Card>
            </div>
          </div>
        </section>
