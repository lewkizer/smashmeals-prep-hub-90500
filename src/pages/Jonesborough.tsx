          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Fresh, chef-prepared meals delivered to Tennessee's oldest town. 100% gluten-free with complete nutrition tracking.
              </p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Delivered to Jonesborough</p>
              </Card>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <Card className="p-8 max-w-2xl mx-auto">
              ...
              <h3 className="text-2xl font-bold mb-4">Free Jonesborough Delivery</h3>
