...
const Harriman = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Gluten-Free Meal Prep Harriman TN | SmashMeals Delivery</title>
        <meta name="description" content="Fresh gluten-free meal prep delivery to Harriman, TN. Chef-prepared meals for Roane County." />
        <meta name="keywords" content="meal prep Harriman, gluten free Harriman TN, healthy meal delivery Harriman" />
        <link rel="canonical" href="https://smashmeals.com/harriman" />
      </Helmet>

      <CitySchema cityName="Harriman" state="Tennessee" stateAbbr="TN" />

      <Header />
      <PageBreadcrumb parentPage={{ label: "Service Areas", href: "/service-areas" }} currentPage="Harriman, TN" />
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              <div className="flex items-center justify-center gap-2 text-primary">
                ...
                <span className="text-lg font-semibold">Now Shipping to Harriman, TN</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold font-playfair">
                Gluten-Free Meal Prep<br />for Harriman
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Fresh, chef-prepared meals delivered to Harriman and Roane County.
              </p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Delivered to Harriman</p>
              </Card>
            </div>
          </div>
        </section>
