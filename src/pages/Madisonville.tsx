...
const Madisonville = () => {
  const faqs = [
    { question: "Do you deliver to Madisonville, TN?", answer: "Yes! We ship to Madisonville and Monroe County via FedEx 2-day delivery. Free shipping on orders over $130." },
  ...
  return (
    <>
      <Helmet>
        <title>Gluten-Free Meal Prep Madisonville TN | SmashMeals Delivery</title>
        <meta name="description" content="Fresh gluten-free meal prep delivery to Madisonville, TN. Chef-prepared meals for Monroe County." />
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              <div className="flex items-center justify-center gap-2 text-primary">
                ...
                <span className="text-lg font-semibold">Now Shipping to Madisonville, TN</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold font-playfair">
                Gluten-Free Meal Prep<br />for Madisonville
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Fresh, chef-prepared meals delivered to Madisonville and surrounding areas.
              </p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Delivered to Madisonville</p>
              </Card>
            </div>
          </div>
        </section>
