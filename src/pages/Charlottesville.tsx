...
const Charlottesville = () => {
  return (
    <>
      ...
      <CitySchema cityName="Charlottesville" state="Virginia" stateAbbr="VA" />

      <Header />
      <PageBreadcrumb parentPage={{ label: "Service Areas", href: "/service-areas" }} currentPage="Charlottesville, VA" />
