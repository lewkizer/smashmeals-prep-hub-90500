...
const PineyFlats = () => {
  return (
    <>
      ...
      <CitySchema cityName="Piney Flats" state="Tennessee" stateAbbr="TN" />

      <Header />
      <PageBreadcrumb parentPage={{ label: "Service Areas", href: "/service-areas" }} currentPage="Piney Flats, TN" />
