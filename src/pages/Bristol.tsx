          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Free delivery to Bristol TN & VA or pickup Sunday-Monday</p>
              </Card>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4">Free Bristol Delivery</h3>
                <p className="text-muted-foreground mb-4">
                  Complimentary delivery throughout Bristol including:
                </p>
