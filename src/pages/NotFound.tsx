      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-b from-primary/10 via-background to-background pt-32 pb-20">
        <div className="text-center max-w-2xl mx-auto px-4">
          ...
          <p className="text-sm text-muted-foreground mt-8">
            Looking for something specific? Try our <a href="/menu" className="text-primary hover:underline">weekly menu</a>, 
            {' '}<a href="/freezer-meals" className="text-primary hover:underline">freezer meals</a>, 
            {' '}or <a href="/blogs" className="text-primary hover:underline">blog</a>.
          </p>
        </div>
      </div>
      <Footer />
