...
const Rutledge = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Meal Prep Delivery Rutledge TN | Gluten-Free Meals | SmashMeals</title>
        <meta name="description" content="Fresh gluten-free meal prep delivered to Rutledge, Tennessee. Chef-prepared meals with free local delivery. Order healthy meals in Grainger County today!" />
        <meta name="keywords" content="meal prep Rutledge TN, gluten-free meals Rutledge, food delivery Grainger County, healthy meal delivery East Tennessee" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
                Gluten-Free Meal Prep Delivery in Rutledge, Tennessee
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Fresh, chef-prepared gluten-free meals delivered right to your door in Rutledge. 
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-muted-foreground">
                  Your meals arrive fresh at your Rutledge home, ready to heat and enjoy.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              ...
              <div className="bg-card p-6 rounded-xl border">
                ...
                <p className="text-muted-foreground text-sm">
                  Family-owned in the Tri-Cities, serving Grainger County with care.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Join your neighbors in Grainger County who are saving time and eating healthier with SmashMeals.
            </p>
