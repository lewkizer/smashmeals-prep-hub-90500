...
const Seymour = () => {
  return (
    <>
      <Helmet>
        <title>Gluten-Free Meal Prep Seymour TN | SmashMeals Delivery</title>
        <meta name="description" content="Fresh gluten-free meal prep delivery to Seymour, TN. Chef-prepared meals for Sevier County." />
        <meta name="keywords" content="meal prep Seymour, gluten free Seymour TN, healthy meal delivery Seymour" />
        <link rel="canonical" href="https://smashmeals.com/seymour" />
      </Helmet>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              <div className="flex items-center justify-center gap-2 text-primary">
                ...
                <span className="text-lg font-semibold">Now Shipping to Seymour, TN</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold font-playfair">
                Gluten-Free Meal Prep<br />for Seymour
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Fresh, chef-prepared meals delivered to Seymour and surrounding areas.
              </p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Delivered to Seymour</p>
              </Card>
            </div>
          </div>
        </section>
