...
const NewTazewell = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Meal Prep Delivery New Tazewell TN | Gluten-Free Meals | SmashMeals</title>
        <meta name="description" content="Fresh gluten-free meal prep delivered to New Tazewell, Tennessee. Chef-prepared meals with convenient delivery. Order healthy meals in Claiborne County today!" />
        <meta name="keywords" content="meal prep New Tazewell TN, gluten-free meals New Tazewell, food delivery Claiborne County, healthy meal delivery East Tennessee" />
        <link rel="canonical" href="https://smashmeals.com/new-tazewell" />
      </Helmet>
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium">Serving New Tazewell & Claiborne County</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
                Gluten-Free Meal Prep Delivery in New Tazewell, Tennessee
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Fresh, chef-prepared gluten-free meals delivered right to your door in New Tazewell. 
        ...
        <section className="py-16 bg-card">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              How Meal Prep Delivery Works in New Tazewell
            </h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-muted-foreground">
                  Your meals arrive fresh at your New Tazewell home, ready to heat and enjoy.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Why New Tazewell Chooses SmashMeals
            </h2>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Start Eating Better in New Tazewell?
            </h2>
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Join your neighbors in Claiborne County who are saving time and eating healthier with SmashMeals.
            </p>
